...
}
{
	...
	(function (f) {
        ...
        console.log('using window for buffer');
				g = window;
			} else if (typeof global !== "undefined") {
        console.log('using global for buffer');
				g = global;
			} else if (typeof self !== "undefined") {
        console.log('using self for buffer');
				g = self;
			} else {
        console.log('using this for buffer');
				g = this;
			}
			g.buffer = f();
		}
				...
				1: [
					function (require, module, exports) {
						...
						function toByteArray(b64) {
							...
							var len =
								placeHoldersLen > 0 ? validLen - 4 : validLen;
...
/*
     FILE ARCHIVED ON 01:21:45 May 05, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 12:35:48 Aug 30, 2022.
...
/*
playback timings (ms):
  captures_list: 8876.453
  exclusion.robots: 0.173
  exclusion.robots.policy: 0.158
  cdx.remote: 0.109
  esindex: 0.013
  LoadShardBlock: 189.372 (3)
  PetaboxLoader3.datanode: 44.303 (4)
  CDXLines.iter: 17.287 (3)
  PetaboxLoader3.resolve: 111.48 (2)
  load_resource: 45.148
*/
